...
// Default developers (used if no prop is passed)
...
type FooterProps = {
  /** Optional override for developer avatars shown in the tooltip row */
  people?: AnimatedTooltipItem[];
};

export default function Footer({ people = DEFAULT_PEOPLE }: FooterProps) {
  return (
    <footer
    ...
    >
      ...
      {/* Developers row inline with tooltips */}
